...
<head>
    ...
    <style>
        ...
        /* Pipeline Table to match reference image */
        table { border-collapse: collapse; text-align: center; font-size: 14px; margin-top: 10px; }
            ...
            data.instructions.forEach((inst, index) => {
                ...
                for(let i = 0; i < data.cycles; i++) {
                    ...
                    if(stage) {
                        ...
                        html += `<td class="${cssClass}">${displayTxt}</td>`;
                    } else {
